...
-- For kanagawa wave, below forces some stubborn UI elements to be transparent
...
--Additional settings to make completions _seem_ semi-transparent
...
vim.api.nvim_set_hl(0, "PmenuBorder", { bg = "#1a1a28", fg = "#7e9cd8" }) -- if you have borders
